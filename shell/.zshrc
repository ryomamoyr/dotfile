...
HISTSIZE=1000000                   # メモリ上に保存する履歴のサイズ
...
# 小型高速モデル（Haiku 3.5 v2）
# export ANTHROPIC_SMALL_FAST_MODEL="arn:aws:bedrock:ap-northeast-1:590184100863:inference-profile/apac.anthropic.claude-3-5-sonnet-20241022-v2:0"
