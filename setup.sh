...
ln -sf "$(pwd)/.snippets" "$HOME/Library/Application Support/Code/User/snippets"
ln -sf "$(pwd)/.vscode/User/settings.json" "$HOME/Library/Application Support/Code/User/settings.json"
ln -sf "$(pwd)/.vscode/User/keybindings.json" "$HOME/Library/Application Support/Code/User/keybindings.json"
mkdir -p "$HOME/Library/Application Support/Cursor/User"
ln -sf "$(pwd)/.cursor/User/settings.json" "$HOME/Library/Application Support/Cursor/User/settings.json"
ln -sf "$(pwd)/.cursor/User/keybindings.json" "$HOME/Library/Application Support/Cursor/User/keybindings.json"
